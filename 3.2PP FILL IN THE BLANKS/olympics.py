...
def main():
    ...
    margin: int # differnce between gold medal counts

    # display program title
    print("PARIS OLYMPICS DAILS GOLD TALLY")
    print()

    # Prompt the user to enter the required information
    first_place = input("Enter the name of the country in first place: ")
    capital_city = input("Enter the captial city of the first place country: ")
